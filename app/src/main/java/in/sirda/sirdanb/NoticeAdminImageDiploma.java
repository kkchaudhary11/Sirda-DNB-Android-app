...
public class NoticeAdminImageDiploma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final BasicImageDownloader downloader = new BasicImageDownloader(new BasicImageDownloader.OnImageLoaderListener() {
            ...
            public void onError(BasicImageDownloader.ImageError error) {
                Toast.makeText(NoticeAdminImageDiploma.this,"Unable to download image", Toast.LENGTH_LONG).show();
 ...
 /* save the image - I'm gonna use JPEG */
                ...
                BasicImageDownloader.writeToDisk(myImageFile, result, new BasicImageDownloader.OnBitmapSaveListener() {
                    ...
                    public void onBitmapSaveError(BasicImageDownloader.ImageError error) {
                        Toast.makeText(NoticeAdminImageDiploma.this, "Error code " + error.getErrorCode() + ": " +
                ...
                imgDisplay.startAnimation(AnimationUtils.loadAnimation(NoticeAdminImageDiploma.this, android.R.anim.fade_in));
            }
        });
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    HttpPost httpPost = new HttpPost(add + "deletediploma.php");
            ...
            protected void onPostExecute(String result) {
                ...
                Intent list = new Intent(NoticeAdminImageDiploma.this, NoticeAdminDiploma.class);
                startActivity(list);
            }
        }
