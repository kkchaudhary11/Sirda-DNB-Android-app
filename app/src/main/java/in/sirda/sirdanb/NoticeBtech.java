...
public class NoticeBtech extends AppCompatActivity {
            ...
            public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
                ...
                if (!pid.isEmpty()) {
                    ...
                    if (!urlstr.contains("http://") && !urlstr.contains("https://")) {
                        Toast.makeText(NoticeBtech.this, "Image Not Available", Toast.LENGTH_SHORT).show();
                    } else {
